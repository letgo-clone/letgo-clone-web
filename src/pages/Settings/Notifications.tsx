                  ...
                  <Box sx={privacyStyles.settingsLeftBox}>
                      <Grid container>
                          ...
                          <Grid item lg={12} xl={12} md={12} sm={12} xs={12} sx={privacyStyles.settingContentGrid}>
                              <Grid container>
                                  <Grid item lg={6} xl={6} md={6} sm={6} xs={6}>
                                          ...
                                          <Typography sx={privacyStyles.settingLeftSubText}>Güncellemeler ve kampanyalar hakkında bildirim al</Typography>
                                  </Grid>
                                  <Grid item lg={6} xl={6} md={6} sm={6} xs={6}>
                          ...
                          <Grid item lg={12} xl={12} md={12} sm={12} xs={12} sx={privacyStyles.settingContentGrid}>
                              <Grid container>
                                  <Grid item lg={6} xl={6} md={6} sm={6} xs={6}>
                                          <Typography sx={privacyStyles.settingLeftText}>Öneriler</Typography>
                                          <Typography sx={privacyStyles.settingLeftSubText}>Etkinliğine dayalı öneriler al</Typography>
                                  </Grid>
                                  <Grid item lg={6} xl={6} md={6} sm={6} xs={6}>
                                      <Box sx={privacyStyles.settingRightBox}>
                                          <Switch defaultChecked color="error" />
